    ...
    return (
        <main>
            ...
            <section className="bg-[#F5F5F5] py-5 xl:py-6">
                <h2 className='text-black text-center text-2xl md:text-3xl 2xl:text-[40px] 2xl:leading-[64px] mb-5 2xl:mb-8 font-medium'>Top companies <span className="font-kalam font-bold text-red">hiring</span> now</h2>
                <div className="w-full flex flex-col items-center mb-5 md:mb-8 xl:mb-14 2xl:my-16  mx-auto">
            ...
            <section className="py-5 xl:py-6">
                ...
                <h2 className='text-black text-center text-2xl md:text-3xl 2xl:text-[40px] 2xl:leading-[64px] mb-5 xl:mb-8 font-medium'>What type of <span className="font-kalam text-red font-bold">job</span> are you looking for?</h2>
                <div className="container grid grid-cols-1 xl:grid-cols-3 gap-4 w-full mb-5 md:mb-8 xl:mb-14 2xl:mb-16">
                    {JobTypes.map((job, index) => (
                    <JobtypeCard key={index} {...job} />
                    ))}
                </div>
                <h2 className='text-black text-center text-2xl md:text-3xl 2xl:text-[40px] 2xl:leading-[64px] mb-5 xl:mb-8 font-medium'>Explore job opportunities across top  <span className="font-kalam text-red font-bold">industries</span> </h2>
            ...
            <section className="bg-[#F5F5F5]">
                <div className="container no-pad py-5 md:py-8 xl:py-14 2xl:py-16">
                    <div className="bg-[#FEF5E4] rounded-[24px] p-6 2xl:p-9 flex flex-col lg:flex-row gap-4 xl:gap-6">
                        ...
                        <h2 className="mx-auto max-w-[400px] flex-shrink-0 2xl:max-w-[500px] text-xl md:text-3xl xl:text-2xl 2xl:text-[40px] 2xl:leading-[52px] font-medium">Kaabil helps you create resumes, practice for interviews, and get jobs!</h2>
                        </div>
            ...
            <section className="pb-5 xl:pb-6 bg-[#F5F5F5]">
                ...
                <div className="section-heading mb-5 xl:mb-8 container">
                    <h2 className='text-black text-center text-2xl md:text-3xl 2xl:text-[40px] 2xl:leading-[64px] font-medium mb-2'>Learn key <span className="font-kalam text-red font-bold ">skills</span> for career success</h2>
            ...
            <section className="pt-5 xl:pt-6 bg-[#E6E7E8] relative">
            ...
            <section className="py-5 xl:py-6">
                <div className="container small gap-5 xl:gap-10 2xl:gap-14 flex flex-col md:flex-row-reverse items-center my-5 md:my-8 xl:my-14 2xl:my-16  mx-auto">
                    <div className="section-heading mb-5 xl:mb-8 flex-1">
                        <h2 className='text-black text-start text-2xl md:text-3xl 2xl:text-[40px] 2xl:leading-[64px] font-medium mb-2'>Why choose <span className="font-kalam text-red">Kaabil?</span></h2>
                        <p className="font-normal xl:text-sm 2xl:text-xl 2xl:leading-9"><span className="font-semibold">Kaabil, in partnership with Mahindra Rise,</span> empowers women jobseekers, especially first-timers, by connecting them to diverse opportunities, local jobs, and skill development resources.</p>
                        ...
                        <div className="flex gap-5">
                            <div className="text-red xl:text-lg">
                                <span className="font-semibold text-3xl md:text-2xl 2xl:text-[40px] leading-[140%]">500k+</span> <br /> Women on the platform
                            </div>
                            <div className="text-red xl:text-lg">
                                <span className="font-semibold text-3xl md:text-2xl 2xl:text-[40px] leading-[140%]">500k+</span> <br /> Women on the platform
                            </div>
                ...
                <div className="w-full flex flex-col my-5 md:my-8 xl:my-14 2xl:my-16  mx-auto">
                    <div className="container">                        
                        <div className="section-heading md:ml-[70px]">
                            <h2 className='text-black text-start text-2xl md:text-3xl 2xl:text-[48px] 2xl:leading-[54px]  font-medium'>Articles</h2>
