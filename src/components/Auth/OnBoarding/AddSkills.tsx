...
export default function AddSkills({ size, closePopup, handleBack }: any) {
  ...
  return (
    ...
    >
      <div className="pb-6 add-skill-dailog">
        {/* @ts-ignore */}
        <DialogHeader>
        ...
        >
          ...
          <DialogBody className="custom-dialog-body custom-scroll dailog-height">
            ...
            >
              <h4 className="text-[14px] sm:text-lg font-medium text-[#231F20]">Add Skills</h4>
              <p
                className={`${
          ...
          {/* @ts-ignore */}
          <DialogFooter className="p-0 pb-6 !px-12 mt-5 flex justify-center dailog-footer-fixed progress-footer">
