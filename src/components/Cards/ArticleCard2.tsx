  ...
  return (
    <Link href={'/articles/new'} className='!P-[5px] block rounded-xl shadow-lg bg-white cursor-pointer group'>
        ...
        <div className="block p-3 md:p-4 2xl:p-5">
            <h3 className='font-medium text-black text-[16px] md:text-base 2xl:text-2xl mb-2 lg:mb-4 xl:mb-5 2xl:mb-6 line-clamp-3'>Mental health support- not a one-off area of focus</h3>
            ...
            <div className="flex justify-between gap-2 sm:gap-1 flex-wrap">
              <div className="flex items-center gap-1">
                ...
                <div className="author-info">
                    <div className="author-name text-black font-medium  text-[10px] 2xl:text-sm">By Dr Praveen Kumari Singh |</div>
                </div>
