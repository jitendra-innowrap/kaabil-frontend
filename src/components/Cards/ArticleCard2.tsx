  ...
  return (
    <Link href={`/articles/${props?.id}`} className='!P-[5px] block h-full rounded-xl shadow-lg relative bg-white cursor-pointer group article-card'>
        ...
        <div className="overflow-hidden rounded-lg">
          ...
          width={447}
          height={273}
          className='mx-auto object-cover w-full group-hover:scale-110 transition-all duration-300 h-[170px] md:h-[232px] lg:h-[154px] xl:h-[175px] 2xl:h-[210px] 3xl:h-[251px]'
          alt="company-icons"
          quality={100}
          />
        </div>
        </div>   
        <div className="block p-4 pb-5 xl:pb-4 2xl:p-5">
          <div className="article-content">
            ...
            <div className="article-footer absolute w-full bottom-4 left-0 px-4 2xl:px-5 flex justify-between gap-2 sm:gap-1 flex-wrap">
