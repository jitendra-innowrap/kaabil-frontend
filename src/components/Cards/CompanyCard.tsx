    ...
    <div className="company-card shadow-sm rounded-2xl overflow-hidden">
      <div className="w-full flex flex-col justify-between bg-white p-4 xl:p-3 2xl:p-[22px] text-center">
        <div className="block">
            ...
            <h3 className="font-medium text-xs h-[33px] lg:text-sm lg:h-[40px] 2xl:h-[50px] 2xl:text-lg 3xl:text-xl 3xl:h-[59px] my-3 xl:my-4 line-clamp-2" title={title}>{title}</h3>
        </div>
