...
export default function IndustryCard({icon, title, jobUrl, color}:industryCard) {
  return (
    ...
    <div style={{background:`${color}`}} className={`size-[200px] 2xl:size-[263px] flex flex-col justify-between bg-white rounded-2xl p-4 2xl:p-6 text-center`}>
        <div className="block">
            <Image
            ...
            alt="company-icons"
            />
            <h3 className="font-medium p-4 text-black text-lg 2xl:text-xl mt-4 2xl:mt-6">{title}</h3>
        </div>
    </div>
    </Link>
  )
