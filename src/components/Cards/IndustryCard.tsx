  ...
  return (
    ...
    <div style={{background:`${color}`}} className={`w-full h-full flex flex-col justify-between bg-white rounded-2xl p-4 2xl:p-6 text-center`}>
        <div className="block">
            ...
            alt="company-icons"
            />
            <h3 className="font-medium text-black line-clamp-2 text-sm 2xl:text-xl 3xl:text-[22px] 3xl:leading-[30px] mt-2 2xl:mt-4 mx-auto px-3 max-w-[140px] 2xl:max-w-[180px]">{title}</h3>
        </div>
    </div>
   </Link>
  )
