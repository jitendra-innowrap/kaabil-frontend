...
export default function JobtypeCard({icon, title, jobUrl}:jobcardtype) {
  ...
  return (
    <div onClick={handleClick} className="job-type-card p-3 group cursor-pointer 3xl:max-h-[115px] 2xl:p-4 3xl:p-6 gap-2 lg:gap-4 flex rounded-2xl 2xl:rounded-3xl items-center justify-between bg-lightGrey">
