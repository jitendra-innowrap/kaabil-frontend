...
export default function FilterSidebar() {
  ...
  return (
    ...
    <div className="filters-sidebar lg:min-w-[260px] 3xl:min-w-[320px] h-fit p-4 md:p-6 rounded-[20px] hidden lg:flex bg-white relative flex-col lg:w-fit items-start">
