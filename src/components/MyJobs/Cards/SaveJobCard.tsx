...
export default function SaveJobCard(prop:any) {
  ...
  return (
    <>
      <Link href={`/jobs/detail/${prop?.id}`} passHref legacyBehavior>
        <div className='job-card h-full cursor-pointer flex flex-col justify-between w-full border shadow-sm border-lightGrey rounded-2xl bg-white p-4 3xl:p-6'>
          <div className="flex gap-3 3xl:gap-4 justify-between">
              <div className="flex gap-[10px] 3xl:gap-4">
                ...
                <div className="">
                  ...
                  <p className='text-[12px] lg:text-[8px] mt-1 3xl:text-xs text-[#B9B9B9]'>{timeAgo(prop?.job_posted_date)}</p>
                </div>
          ...
          <div className="flex gap-1 sm:gap-2">
            ...
            <div className='ml-5 text-[11px] 2xl:text-[12px] text-[#545581] flex items-center truncate'>
          ...
          <div className="flex flex-wrap xl:flex-nowrap gap-4 justify-between">
            ...
            <div className="flex action-btns gap-2 3xl:gap-4 flex-wrap xl:max-w-[170px] xl:flex-nowrap justify-start lg:justify-end items-end">
            ...
            {
              isApplied?
              <button type='button' className={`flex applied-btn place-items-center btn-border whitespace-nowrap !py-0 xl:!px-2 3xl:!px-[13px] h-[30px] 3xl:h-[44px] gap-1 3xl:gap-[6px] flex-1 text-[10px] 2xl:text-xs 3xl:text-sm text-[#4D4D4F] !bg-[#f0f1f1] !border-[#f0f1f1] font-medium ${isApplied?"opacity-100 disabled cursor-default":""}`}>
