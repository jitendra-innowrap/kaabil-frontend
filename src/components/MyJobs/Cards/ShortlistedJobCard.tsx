    ...
    <Link href={`/jobs/detail/${prop?.id}`} passHref legacyBehavior>
      <div className='job-card cursor-pointer h-full flex flex-col justify-between w-full border shadow-sm border-lightGrey rounded-2xl bg-white p-4 3xl:p-6'>
        ...
        <div className="flex gap-1 sm:gap-2">
          ...
          <div className='ml-5 text-[11px] lg:text-[10px] 2xl:text-[12px] text-[#545581] flex items-center truncate'>
              ...
              <Image width={15} height={15} src={'/new-assets/icons/rupee.svg'} className='mr-1 2xl:mr-2 size-[11px] 2xl:size-[15px]' alt='rupee icon' />
            {
              ...
              <>
              <span className='text-[11px] lg:text-[10px] 2xl:text-sm'>{`${showSalarySimilarJob(prop?.is_industry_standard || "0", prop?.salary_range_unit ||"0",prop?.min_salary ||"0",prop?.max_salary ||"0")} `} </span>
