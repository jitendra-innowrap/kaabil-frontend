...
export default function MyJobs() {
  const { selectedTab } = useAppSelector((state) => state.jobFiltersMaster);
  ...
  return (
    <div className="container">
      ...
      <h1 className="text-[#231F20] text-xl 3xl:text-2xl font-medium">
        My jobs
      </h1>
        ...
        <div className="w-full">
          ...
          {jobs.length > 0 ? (
            <div className="flex flex-col w-full gap-3 3xl:gap-4">
              <h3 className="text-sm 3xl:text-base text-[#787878]">{`You have applied for ${
                totalJobs || 0
              } jobs`}</h3>
              {jobs.map((job) => (
            ...
            <div className="pt-10 xl:pt-20 3xl:pt-32 bg-[#f9f9f9] mx-auto w-full px-4 pb-12">
              <Image
                className="w-[280px] h-[190px] mx-auto 3xl:w-[323px] 3xl:h-[262px]"
                width={650}
                height={520}
              ...
              <p className="text-sm 3xl:text-base font-normal text-center">
                You haven't followed any company yet. Start following to stay
                updated!
              </p>
            </div>
          )}
