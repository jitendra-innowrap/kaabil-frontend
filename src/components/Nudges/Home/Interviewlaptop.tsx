...
export default function Interviewlaptop() {
  ...
  return (
    <div className="flex flex-col-reverse sm:flex-row sm:items-center bg-white rounded-lg px-5 py-8 2xl:py-11 lg:px-9 2xl:px-14 !pb-0">
        <div className="block pb-8 xl:pb-10 2xl:pb-11 ">
            ...
            <button onClick={handleRegister} className="mt-3 text-[12px] px-3 md:mt-4 xl:!text-xs xl:!px-5">Register to Start Mock Interview</button>
        </div>
        <Image
