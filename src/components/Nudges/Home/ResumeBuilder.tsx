...
export default function ResumeBuilder() {
  return (
    <div className="nudge-card resume flex flex-col-reverse sm:flex-row sm:items-end bg-white rounded-lg py-8 2xl:py-11 px-9 2xl:px-10 !pb-0">
        <div className="nudge-text block pb-8 xl:pb-10 2xl:pb-11">
            <h3 className="text-2xl xl:text-lg 2xl:text-3xl font-medium xl:leading-5 2xl:leading-8">Need help with creating your resume? <br />
