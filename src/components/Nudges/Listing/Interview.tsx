...
export default function Interview() {
  return (<>
        <div className="hidden lg:flex flex-col-reverse sm:flex-row sm:items-center gap-3 bg-[#FEF5E4] justify-between rounded-2xl px-4 3xl:px-6 py-3 3xl:py-5">
        ...
        <div className="block lg:hidden">
              <Image
                  className=" flex-shrink-0 cursor-pointer w-full h-auto"
                  src={'/new-assets/nudges/complete/listing-mock-interview.svg'}
                  width={287}
                  height={253}
                  alt="resume-builder"
                  /> 
