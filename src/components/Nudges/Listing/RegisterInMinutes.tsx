...
export default function RegisterInMinutes() {
  return (
    <div className="flex bg-[#F9D1D7] justify-between rounded-2xl px-4 3xl:px-6 py-3 3xl:py-5">
            <div className="block">
                ...
                <button className="mt-3 md:mt-4 text-xs 3xl:text-sm">Register to Apply jobs</button>
            </div>
            <Image
