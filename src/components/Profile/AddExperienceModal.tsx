...
const AddExperienceModal = forwardRef(
        ...
        <form onSubmit={formik.handleSubmit}>
          <div className="relative mb-2">
            <input
              ...
              className="w-full px-2 py-3 text-md border rounded"
            />
          ...
          <input
            ...
            className="mb-2 w-full px-2 py-3 text-md border rounded"
          />
          ...
          <div className="flex items-center gap-2 my-4">
            ...
            />
            <label htmlFor="isCurrentCompany" className="!mb-0 inline-block !text-[16px]">
          ...
          <div className="flex gap-3">
            <div className="flex-1">
              ...
              <div>
                <label className="!text-[16px]">Working From</label>
                <input
                  type="date"
                  id="jobStartDate"
                  name="jobStartDate"
            ...
            {isCurrentCompany && (
              <div className="flex-1">
                <label className="!text-[16px]">Worked Till</label>
                <input
                  type="date"
                  id="jobEndDate"
                  name="jobEndDate"
