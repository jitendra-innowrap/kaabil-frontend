...
export default function SearchSection() {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-3 lg:gap-0 mx-auto rounded-[20px] lg:shadow-default max-w-[1313px] lg:bg-white xl:h-[80px] 2xl:h-[100px] items-center">
          ...
          />
          <button  className="md:text-lg justify-center w-full lg:w-fit font-semibold px-6 flex xl:px-8 xl:h-[80px] 2xl:h-[100px] whitespace-nowrap bg-[#E41C3B] text-white"> <HiMagnifyingGlass className='size-7 mr-3'/> Search Jobs</button>
        </div>
  )
}
